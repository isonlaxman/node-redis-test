...
class RedisPoolMember {
    constructor(client, releaseFunction) {
        ...
        this.incr = (key) => __awaiter(this, void 0, void 0, function* () {
            try {
                if (this.isConnected) {
        ...
        this.watch = (key) => __awaiter(this, void 0, void 0, function* () {
            try {
                if (this.isConnected) {
        ...
        this.discard = () => __awaiter(this, void 0, void 0, function* () {
            try {
                if (this.isConnected) {
        ...
        this.exec = (multi) => __awaiter(this, void 0, void 0, function* () {
            try {
                if (this.isConnected) {
